        ...
        <div className="toolbar mb-4">
          ...
          >
            ...
            >
              ...
              <text x="4" y="19" fontSize="6" fill="black">3.</text>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"  className="inline-flex">
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"  className="inline-flex">
              <path d="M6 9L3 12L6 15" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M3 12H14C17.3137 12 20 14.6863 20 18V18" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"  className="inline-flex">
              <path d="M18 9L21 12L18 15" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M21 12H10C6.68629 12 4 14.6863 4 18V18" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          ...
          <span onClick={addImage}>Add Image</span>
        </div>
